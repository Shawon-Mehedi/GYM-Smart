...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_profile'])) {
  ...
  $updateQuery = "UPDATE admin SET name = ?, email = ?, phone = ?";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['change_password'])) {
    ...
    if ($stmt = $conn->prepare($query)) {
        ...
        if (password_verify($currentPassword, $admin_data['password'])) {
            ...
            $updatePasswordQuery = "UPDATE admin SET password = ? WHERE id = ?";
...
<head>
  ...
  <title>admin / Profile - NiceAdmin Bootstrap Template</title>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
                ...
                <span>
                    <?php 
                    // Assuming session variable 'user_type' holds the value 'User' or 'Admin'
