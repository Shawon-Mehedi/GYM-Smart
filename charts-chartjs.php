...
<head>
  ...
  <title>Charts / Chart.js - GymSmart</title>
...
<!-- End Search Bar -->
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Attendance and Progress Charts</h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Attendance Bar Chart</h5>
                ...
                document.addEventListener("DOMContentLoaded", () => {
                  new Chart(document.querySelector('#barChart'), {
                    ...
                    data: {
                      ...
                      datasets: [{
                        label: 'Attendance',
                        data: [90, 75, 80, 85], // Replace with actual attendance data
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Progress Line Chart</h5>
                ...
                document.addEventListener("DOMContentLoaded", () => {
                  new Chart(document.querySelector('#lineChart'), {
                    ...
                    data: {
                      ...
                      datasets: [{
                        label: 'Progress',
                        data: [50, 60, 70, 85], // Replace with actual progress data
                        fill: false,
