      ...
      <div class="row justify-content-center">
        <div class="col-lg-8">
          ...
          <div class="card shadow-sm border-0">
            <div class="card-body">
              <h5 class="card-title text-center">Your Achievements</h5>
              <p class="text-center text-muted">Earned badges based on your progress and activities</p>
  
              <div class="d-flex flex-wrap justify-content-center gap-3">
  
                <!-- Styled Badges with Icons (using FontAwesome icons) -->
                <div class="badge-container">
                  <span class="badge bg-primary p-3"><i class="fas fa-trophy"></i>365 Champion</span>
                </div>
  
                <div class="badge-container">
                  <span class="badge bg-secondary p-3"><i class="fas fa-medal"></i>Top Performer</span>
                </div>
  
                <div class="badge-container">
                  <span class="badge bg-success p-3"><i class="fas fa-heart"></i>Wellness</span>
                </div>
  
                <div class="badge-container">
                  <span class="badge bg-danger p-3"><i class="fas fa-fire"></i>Streak Master</span>
                </div>
  
                <div class="badge-container">
                  <span class="badge bg-warning text-dark p-3"><i class="fas fa-bolt"></i>Supportive</span>
                </div>
  
                <div class="badge-container">
                  <span class="badge bg-info text-dark p-3"><i class="fas fa-lightbulb"></i>Early Bird</span>
                </div>
  
                <div class="badge-container">
                  <span class="badge bg-light text-dark p-3"><i class="fas fa-star"></i>Seasonal Champ</span>
                </div>
  
                <div class="badge-container">
                  <span class="badge bg-dark p-3"><i class="fas fa-crown"></i> Comeback Kid</span>
                </div>
