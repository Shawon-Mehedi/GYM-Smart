...
<!-- End Search Bar -->
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Gym Trainer Evaluation Form</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Evaluate Your Trainer</h5>

                        <!-- Feedback message (hidden initially) -->
                        <div id="message" class="alert d-none"></div>

                        <!-- Gym Trainer Evaluation Form -->
                        <form id="evaluation-form">
                            <div class="row mb-3">
                                <label for="trainerName" class="col-sm-3 col-form-label">Trainer Name</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="trainerName" placeholder="Enter trainer's name" required>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="sessionDate" class="col-sm-3 col-form-label">Session Date</label>
                                <div class="col-sm-9">
                            ...
                            <div class="row mb-3">
                                <label for="overallRating" class="col-sm-3 col-form-label">Overall Rating</label>
                                <div class="col-sm-9">
                                    <input type="range" class="form-range" id="overallRating" min="1" max="5" step="1" required>
                                    <small>1 (Poor) - 5 (Excellent)</small>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="communication" class="col-sm-3 col-form-label">Communication Skills</label>
                                <div class="col-sm-9">
                                    <select class="form-select" id="communication" required>
                                        <option selected disabled>Rate Communication Skills</option>
                            ...
                            <div class="row mb-3">
                                <label for="motivation" class="col-sm-3 col-form-label">Motivation Provided</label>
                                <div class="col-sm-9">
                                    <select class="form-select" id="motivation" required>
                                        <option selected disabled>Rate Motivation Provided</option>
                                        <option value="1">1 - Poor</option>
                                        <option value="2">2 - Fair</option>
                                        <option value="3">3 - Good</option>
                                        <option value="4">4 - Very Good</option>
                            ...
                            <div class="row mb-3">
                                <label for="professionalism" class="col-sm-3 col-form-label">Professionalism</label>
                                <div class="col-sm-9">
                                    <select class="form-select" id="professionalism" required>
                                        <option selected disabled>Rate Professionalism</option>
                                        <option value="1">1 - Poor</option>
                                        <option value="2">2 - Fair</option>
                                        <option value="3">3 - Good</option>
                                        <option value="4">4 - Very Good</option>
                            ...
                            <div class="row mb-3">
                                <label for="knowledge" class="col-sm-3 col-form-label">Knowledge of Exercises</label>
                                <div class="col-sm-9">
                                    <select class="form-select" id="knowledge" required>
                                        <option selected disabled>Rate Knowledge</option>
                                        <option value="1">1 - Poor</option>
                                        <option value="2">2 - Fair</option>
                                        <option value="3">3 - Good</option>
                                        <option value="4">4 - Very Good</option>
                            ...
                            <div class="row mb-3">
                                <label for="punctuality" class="col-sm-3 col-form-label">Punctuality</label>
                                <div class="col-sm-9">
                                    <select class="form-select" id="punctuality" required>
                                        <option selected disabled>Rate Punctuality</option>
                                        <option value="1">1 - Poor</option>
                                        <option value="2">2 - Fair</option>
                                        <option value="3">3 - Good</option>
                                        <option value="4">4 - Very Good</option>
                            ...
                            <div class="row mb-3">
                                <label for="comments" class="col-sm-3 col-form-label">Additional Comments</label>
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="comments" rows="4" placeholder="Share your experience"></textarea>
                                </div>
                            </div>
                        ...
                        </form><!-- End Trainer Evaluation Form -->
                        ...
                        <script>
                            document.getElementById('evaluation-form').addEventListener('submit', (event) => {
                                ...
                                // Get form data
                                const trainer_name = document.getElementById('trainerName').value;
                                const session_date = document.getElementById('sessionDate').value;
                                const overall_rating = document.getElementById('overallRating').value;
                                ...
                                const data = { trainer_name, session_date, overall_rating, communication, motivation, professionalism, knowledge, punctuality, comments };

                                // Clear message display
                                const messageDiv = document.getElementById('message');
                                messageDiv.classList.add('d-none'); // Hide initially
                                ...
                                .catch(error => {
                                    ...
                                    // Display error message
                                    messageDiv.innerText = 'An error occurred while saving the evaluation.';
                                    messageDiv.classList.remove('d-none');
                                    messageDiv.classList.add('alert-danger');
                                });
                            });
